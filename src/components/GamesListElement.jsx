...
export default function GamesListElement(props) {
  return (
    <div
      className="transition-all duration-200 ease-in flex justify-start items-center h-24 w-full bg-gradient-to-r from-sky-500 to-indigo-500 my-3 rounded cursor-pointer opacity-90 hover:opacity-100"
